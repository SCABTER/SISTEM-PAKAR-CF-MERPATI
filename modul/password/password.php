...
<text class="text-danger">Akun yang sedang di gunakan </text>"<?php echo ucfirst($_SESSION['username']); ?>"
<?php
...
echo "	<form method='post' action='?module=password&act=updatepassword'>
		...
		<br><tr><td width=220>Password lama</td><td><input class='form-control' autocomplete='off' placeholder='password lama....' type='password' name='oldPass' /></td></tr>
		<br><tr><td>Password baru</td><td><input class='form-control' autocomplete='off' placeholder='password baru....' type='password' name='newPass1' /></td></tr>
		<br><tr><td>Masukkan kembali password baru</td><td><input class='form-control' autocomplete='off' placeholder='Masukan kembali....' type='password' name='newPass2' /></td></tr>
		<tr><td></td><td>
