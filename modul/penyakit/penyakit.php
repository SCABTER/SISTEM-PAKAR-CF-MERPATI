...
if (!(isset($_SESSION['username']) && isset($_SESSION['password']))) {
  ...
  switch ($_GET[act]) {
    ...
    default:
      ...
      echo "<h6 class='m-0 font-weight-bold text-primary fas fa-bug fa-2x text-black-50-300'> Penyakit </h6>
                 <form class='d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search' method=POST action='?module=penyakit' name=text_form onsubmit='return Blank_TextField_Validator_Cari()'>
                        <div class='input-group'>
                            ...
                            <div class='input-group-append'> &nbsp;
                            <button class='btn bg-olive border-1 margin btn-Primary ' type=button name=tambah value='' onclick=\"window.location.href='penyakit/tambahpenyakit';\"><i class='fa fa-plus' aria-hidden='true'></i></button>
                        </div>
                        </div>
                    </form>     
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
		  ...
		  <tr><td width=120>Saran Pengobatan</td><td><textarea rows='4' cols='50' class='form-control' name='srn_penyakit'type=text placeholder='Masukkan saran penyakit baru...'></textarea></td></tr>
